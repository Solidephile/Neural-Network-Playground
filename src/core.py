...
class Model:
    ...
    def train(
        ...
        *,
        ...
        for epoch in range(1, epochs + 1):
            ...
            for step in range(train_steps):
                ...
                if not step % print_every or step == train_steps - 1:
                    ...
                    progress_data_callback.emit(
                        accuracy, loss, data_loss, regularization_loss, self.optimizer.current_learning_rate
                    )
            ...
            if validation_data is not None:
                # Evaluate the model:
                self.evaluate(*validation_data, batch_size=batch_size, validation_callback=validation_callback)
    ...
    def evaluate(self, X_val, y_val, *, batch_size=None, validation_callback=None):
        # Default value if batch size is not being set
        validation_steps = 1
